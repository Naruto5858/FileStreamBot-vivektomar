...
<b>𝐌𝐚𝐢𝐧𝐭𝐚𝐢𝐧𝐞𝐝 𝐁𝐲: @ChVivekTomar</b>""",
            parse_mode="HTML",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Owner', url=f"https://t.me/ChVivekTomar"),
        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                if user.status == "kicked":
                    await b.send_message(
                        chat_id=m.chat.id,
                        text="**Sᴏʀʀʏ Sɪʀ, Yᴏᴜ ᴀʀᴇ Bᴀɴɴᴇᴅ ᴛᴏ ᴜsᴇ ᴍᴇ. Qᴜɪᴄᴋʟʏ ᴄᴏɴᴛᴀᴄᴛ** @ChVivekTomar",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
...
<b>🖥 𝐎𝐧𝐥𝐢𝐧𝐞 𝐖𝐚𝐭𝐜𝐡 𝐋𝐢𝐧𝐤 :</b> <code>{}</code>
